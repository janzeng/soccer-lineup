...
Lineup Generator is a lightweight, browser-based tool designed for youth soccer coaches to create fair, balanced, and strategic player rotations. It supports 7v7, 9v9, and 11v11 formats and uses a custom "Fair-Play" algorithm to ensure every child gets equal time on the pitch and on the bench.
...
The generator tracks every shift in real-time. When calculating substitutions:
...
### Goalie Logic
The app handles goalkeeper transitions based on how many players are assigned the Goal (G) role:
* **1 Goalie:** Plays the entire game.
* **2 Goalies:** Swaps at halftime (Quarter 3). 
  * *The "Gear Up" Rule:* To ensure the second-half goalie is ready, the algorithm automatically benches them during Quarter 2, Shift 2 so they have time to put on their gloves and jersey.
* **3+ Goalies:** Rotates the goalkeeper role evenly every quarter.
